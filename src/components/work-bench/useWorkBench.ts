 ...
 * @LastEditTime: 2022-10-22 17:31:59
 * @LastEditors: zouyaoji
 * @Description:
 * @FilePath: \vue-cesium-earth\src\components\work-bench\useWorkBench.ts
 */
...
export default function () {
  ...
  const controlLayout = store.system.useLayoutStore().control
